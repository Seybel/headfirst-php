...
<body>
    ...
    <p>Welcome, Guitar Warrior, do you have what it takes to crack the high score list? If so, just <a href="uploadscore.php">add your own score</a>.</p>
    <hr />
    ...
    while ($row = mysqli_fetch_array($data)) {
      ...
      // die(var_dump(__DIR__ . '/' . ($row['screenshot'])));
